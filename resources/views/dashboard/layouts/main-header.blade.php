                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                <img src="{{ URL::asset('assets/dashboard/img/flags/' . app()->getLocale() . '_flag.jpg') }}" alt="img">
                            </span>
                            <div class="my-auto">
                                <strong class="mr-2 ml-2 my-auto">
                                    {{ LaravelLocalization::getSupportedLocales()[app()->getLocale()]['name'] ?? strtoupper(app()->getLocale()) }}
                                </strong>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode) }}" class="dropdown-item d-flex ">
                                    <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                            src="{{ URL::asset('assets/dashboard/img/flags/' . $localeCode . '_flag.jpg') }}"
                                            alt="img"></span>
                                    <div class="d-flex">
                                        <span class="mt-2">{{ $properties['name'] }}</span>
                                    </div>
                                </a>
                            @endforeach
                        </div>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form method="POST"
                            action="{{ auth('admin')->check() ? route('admin.logout') : route('user.logout') }}">
                            @csrf
